...
```{r results='markup'}
library(pROC)
svm_predict <- predict(svm_linear, test_data, probability =TRUE)
roc_svm_test <-plot(roc(as.numeric(test_data$filtered_joined_churn_df.Churn.Label),as.numeric(svm_predict)),main="Comparaison ",col="#1c61b6")
