...
- According to the model analysis, we found a couple of important feature that would affect whether customers decide to churn or not churn. For example, important features from random forest model includes total charges, tenure months, monthly charges, internet service xfiber optic
*More to add in summary paper*
