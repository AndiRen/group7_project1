...
```{r}
tg_c1 <- tg[,c("Paperless.Billing", "Payment.Method", "Tech.Support","Online.Backup","Contract","Internet.Service","Partner","Senior.Citizen","Dependents","Churn.Label")]
...
testPred <- predict(model.rf, train)
#table(testPred, validation$Churn.Label)

confusionMatrix(as.factor(testPred),
  as.factor(train$Churn.Label))
...
```{r}
tg_c2 <- tg[,c("Paperless.Billing", "Tech.Support","Contract","Internet.Service","Dependents","Churn.Label")]
