...
Here we have created two table for churn and non-churn containing min q1 median man q3 and max.
...
The low p value from the chi sq test also confirm variable dependants has an weightage on deciding people to stay or leave
Apart from the statistical analysis, this can be explained as :

1. If a customer who has dependency need to leave , everyone in the dependency should have to leave all together ,which is more complicated than customer who has no dependants , and who can easily leave the service.

2. Also the service provider may be providing a better plan for customer who has dependants, than their other service competitors.
