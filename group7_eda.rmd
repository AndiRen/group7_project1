...
#### **Partner**
```{r}
test_partner <- chisq.test(table(joined_churn_dfo$Churn.Label, joined_churn_dfo$Partner))
test_partner
```
...
#### **Paperless Billing**
```{r}
test2 <- chisq.test(joined_churn_df(telco$Churn.Label, joined_churn_df$Paperless.Billing))
test2
#p-value <2e-16, it is not independent. The two variables relate to each other.
